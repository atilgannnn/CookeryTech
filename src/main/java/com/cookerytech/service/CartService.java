...
public class CartService {
    ...
    public CartService(CartRepository cartRepository, CartMapper cartMapper, UserService userService, UserRepository userRepository, CartItemRepository cartItemRepository, CartItemsService cartItemsService) {
    ...
    public CartResponse manageCartItem(Model modelId, Integer amount) {
        ...
        cartResponse.setModel(cartItem.getModel());
